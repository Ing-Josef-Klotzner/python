...
class Car(pygame.sprite.Sprite):
    ...
    def __init__(self, color, width, height, x_pos, y_pos, speed):
...
playerCar = Car(RED, 60, 80, 160, SCREENHEIGHT - 100, 70)
car1 = Car(PURPLE, 60, 80, 60, -100, random.randint(50,100))
car2 = Car(YELLOW, 60, 80, 160, -600, random.randint(50,100))
car3 = Car(CYAN, 60, 80, 260, -300, random.randint(50,100))
car4 = Car(BLUE, 60, 80, 360, -900, random.randint(50,100))
