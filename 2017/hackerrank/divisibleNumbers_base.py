...
def numS (m):
    ...
    i = 0
    if m == 19425: maxcxv = 8
    elif m % 3885 == 0 or m == 16835: maxcxv = 7
    else: maxcxv = 6
    maxcv = 19
    maxc = maxci = 30
...
#                sleep (.001)
        ...
        while getSum (num) < getProd (num) or dgt > 9:
#            if dgtc == 31:
#                print ("a ", num, num - numc, dgtc, cntDgt, dgt, i, end = ", ")
...
#            print (numc, cntDgt, dgtc, end = ", ")
            ...
            if dgtc == maxcx + 1: i += maxc - maxcxv; maxc = maxcxv # ab 42 (26085 62) Stellen
